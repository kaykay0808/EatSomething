...
import com.kay.eatsomething.data.Repository
...
class MainViewModel @Inject constructor(
    ...
    val readRecipes: LiveData<List<RecipesEntity>> = repository.local.readDatabase().asLiveData() // <- convert our flow to livedata
